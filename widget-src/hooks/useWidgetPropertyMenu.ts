    ...
    [
      {
        ...
        options: [
          ...
          { option: 'stickyTagger', label: 'Sticky Tagger' },
        ],
      },
      // Point widget用のプロパティ
      ...(widgetType === 'point'
        ? [
            ...
            },
            {
              ...
              tooltip: 'Automatically groups/ungroups with host (on attach/detach). Toggling also groups/ungroups. Note: Will not ungroup if other objects are in the group.',
        ...
        ? [
            ...
            },
            {
              ...
              options: [
                ...
                { option: 'section', label: 'Parent Section' },
                { option: 'locked_section', label: 'Locked Section' },
              ],
            },
          ]
        : []),
